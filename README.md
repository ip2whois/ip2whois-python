# IP2WHOIS Python SDK
**_Please note that this GitHub project is no longer being maintained and has been migrated to a new repository. We recommend that you use the IP2Location.io Python SDK going forward._**
